...
export const INITIAL_PORTFOLIO_DATA: PortfolioData = {
  general: {
    ...
    tagline: "Architecting Intelligent Systems & Scalable Web Applications.",
    bio: "Designing low-latency multimodal AI pipelines, autonomous multi-agent swarms, and enterprise-grade distributed web applications. Passionate about marrying modern frontend UX with deep neural backend infrastructure.",
    profileImage: "",
    floatingBadge1: "Sub-35ms Inferences",
    floatingBadge2: "Next.js 16 App Router",
  ...
  skillsSection: {
    subBadge: "Tech Arsenal & Architecture",
    titleMain: "Engineering",
    titleAccent: "Expertise",
    titleEnd: "& Capabilities",
    description: "A high-performance technical stack forged across production AI pipelines, distributed cloud systems, and cutting-edge web applications.",
    bento: {
      bento1: {
        badge: "Core Specialization",
        title: "AI & Machine Learning Architecture",
        description: "Specialized in constructing multi-agent swarms, low-latency RAG systems, and high-throughput model serving runtimes.",
        tags: [
          "Agentic Swarms (LangGraph)",
          "Multimodal RAG & ColBERT",
          "vLLM & TensorRT Inference",
          "PyTorch & CUDA Tuning",
          "Function Calling & Guardrails",
          "Embedding Optimization",
        ],
        metric1Label: "Peak Performance",
        metric1Value: "3,200 tok/sec Throughput",
        metric2Label: "Evaluation Benchmark",
        metric2Value: "94.8% Accuracy",
      },
      bento2: {
        badge: "Modern Frontend",
        title: "Full-Stack Engineering",
        description: "Building reactive, 60fps applications with Next.js 16 App Router, TypeScript, and micro-interactions.",
        skillBars: [
          { name: "Next.js 16 (App Router, PPR)", level: "98%" },
          { name: "React 19 & TypeScript", level: "97%" },
          { name: "Tailwind CSS & Framer Motion", level: "95%" },
          { name: "FastAPI, Node.js & WebSockets", level: "93%" },
        ],
        metricLabel: "Lighthouse Vitals",
        metricValue: "100/100 Score",
      },
      bento3: {
        title: "Cloud & Distributed Systems",
        description: "Containerized microservices orchestration, auto-scaling Kubernetes topologies, and automated zero-downtime CI/CD.",
        tags: ["Kubernetes", "Docker", "AWS / GCP", "Kafka", "eBPF", "Terraform"],
      },
      bento4: {
        title: "Vector & High-Scale DBs",
        description: "High-dimensional vector stores with HNSW scalar quantization, PostgreSQL relational modeling, and Redis caching layers.",
        tags: ["Qdrant", "Pinecone", "PostgreSQL", "Redis", "ClickHouse", "Prisma"],
      },
      bento5: {
        title: "System Principles",
        principles: [
          "Sub-50ms Edge TTFB Priority",
          "Deterministic Agentic Guardrails",
